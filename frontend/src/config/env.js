 ...
 */
export const API_BASE_URL = import.meta.env.VITE_API_BASE_URL ?? 'http://localhost:8764';
/**
 ...
 */
export const KATAGO_WS_URL = import.meta.env.VITE_KATAGO_WS_URL ?? 'ws://127.0.0.1:41948';
