...
export function markEngineConnected() {
 ...
 */
export function applyEngineDisconnectReset() {
...
export function setEngineInfo(info) {
 ...
 */
export function refreshEngineVersion(version, versionPayload) {
    store.engine.info = { ...store.engine.info, version, versionPayload };
}
// ── Metrics ───────────────────────────────────────────────────────────────────
/** Once-per-second packet-rate tick (`startMetrics`). */
export function recordPacketRate(packetsPerSecond) {
...
export function markWatchdogPingPending() {
...
export function recordWatchdogPong(latencyMs) {
 ...
 *  (`onAnalysisUpdate`). */
export function recordLastResponseBoard(boardId) {
