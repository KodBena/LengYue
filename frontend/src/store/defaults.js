...
export const defaultSettings = {
        ...
        katago: {
            ...
            analysis_env: {
                ...
                symbols: {
                    ...
                    scoreLead_loss_topvsuser: 'player_sign(x[0]) * ((x[0]["rootInfo"]["scoreLead"] - x[0]["userMoveInfo"]["scoreLead"]) if x[0]["userMoveInfo"] else 0)',
    ...
    knobs: {
        ...
        'engine.first-report-during-search-after': {
            ...
            inputs: [{
                    range: [0.001, 4.0],
                    maxFromKnob: 'engine.report-during-search-every', // KnobId brand mint: static `<domain>.<name>` registry-key literal
...
export const defaultThumbnailSettings = {
    showOnHover: true,
    sizePx: 120,
};
export const defaultCardSets = {
    'default': {
        id: 'default',
        name: 'Standard',
...
export const defaultProfile = {
    id: NIL_UUID, // NIL-UUID brand mint (pre-auth sentinel identity)
    username: 'Guest',
 ...
 */
export const defaultKnownTags = ['$mistake', '$opening', '$joseki', '$life_and_death'];
export const defaultSessionUI = {
    activeTab: 'cards',
