 ...
 */
export function __devForceActiveAnalysisTab(id) {
    if (import.meta.env.DEV)
        devForcedTabId.value = id;
}
export function useAnalysisTabs() {
    const tabs = computed(() => store.profile.settings.analysisTabs ?? []);
