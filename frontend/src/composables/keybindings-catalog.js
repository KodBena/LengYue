...
const asActionId = (id) => id; // brand factory: sole KeybindingActionId mint
/**
...
export const activeBoardExists = () => activeBoard.value !== null;
export const engineConnected = () => store.engine.status === 'connected';
// ── Handler closures ─────────────────────────────────────────
//
...
// ── Registry ─────────────────────────────────────────────────
export const KEYBINDINGS_REGISTRY = [
