/**
 * src/composables/chrome/useLocale.ts
...
import { SUPPORTED_LOCALES, LOCALE_DISPLAY_NAMES, LOCALE_FLAGS, MACHINE_TRANSLATED_LOCALES, isSupportedLocale, DEFAULT_LOCALE, } from '../../i18n/locales';
export function useLocale() {
    ...
    const displayName = (loc) => LOCALE_DISPLAY_NAMES[loc];
    const flag = (loc) => LOCALE_FLAGS[loc];
    const isMachineTranslated = computed(() => MACHINE_TRANSLATED_LOCALES.has(locale.value));
    return {
        locale,
