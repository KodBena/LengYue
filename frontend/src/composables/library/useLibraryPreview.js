...
export function useLibraryPreview() {
    ...
    const parsedBoard = shallowRef(null);
    const variationPath = ref([]);
    ...
    watch(selectedRow, async (row) => {
        ...
        try {
            ...
            if (myGen !== generation)
                return; // newer selection superseded us
