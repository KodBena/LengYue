 ...
 */
export function invalidateNodeSnapshots(nodeIds) {
 ...
 */
export function purgeBoardThumbnails(boardId) {
    ...
    invalidateNodeSnapshots(Object.keys(board.nodes));
}
/**
 ...
 */
export function purgeAllThumbnails() {
...
export function getWoodIfReady() {
...
export function stoneSprite(color, rpx) {
