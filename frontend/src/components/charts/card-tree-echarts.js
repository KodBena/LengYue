...
export function toEChartsNode(node, currentCardId = null, cards = null, selectedCardId = null) {
    if (node.kind === 'card') {
 ...
 */
export function tooltipFor(payload, cards) {
 ...
 * back to the backend.
 */
export function headerLineFor(tree, forestStats) {
    ...
    const players = stat?.playerBlack || stat?.playerWhite
