...
.dark-select { background: var(--surface-1); border: 1px solid var(--border-2); color: var(--accent-primary); padding: 2px 6px; border-radius: 3px; font-size: var(--text-body); outline: none; cursor: pointer; text-transform: uppercase; }
...
.toolbar-btn-sm { background: var(--border-2); border: 1px solid var(--border-3); color: var(--text-1); padding: 2px 6px; font-size: var(--text-body); cursor: pointer; border-radius: 3px; text-transform: uppercase; }
