<!--
  src/components/board/MiniBoardSvg.vue
  Reactive thumbnail Go board — the SVG component projection of a BoardSnapshot.
  ...
  MiniBoardCanvas.vue is the canvas sibling. This SVG variant is the default.
  Its body is the byte-for-byte carry-over of the pre-split MiniBoard SVG;
  tests/integration/MiniBoardSvg.parity.test.ts asserts that carry-over
  against a frozen reference so the split is provably behaviour-preserving.
