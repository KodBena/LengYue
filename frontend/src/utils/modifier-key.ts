...
export function isPasteModifierHeld(e: MouseEvent | KeyboardEvent): boolean {
 ...
 * affordances.
 */
export function isPasteClick(e: MouseEvent): boolean {
 ...
 */
export function isMiddleButtonMousedown(e: MouseEvent): boolean {
  return e.button === 1;
}

/** Display name for the paste modifier on the current platform. */
export function pasteModifierLabel(): 'Cmd' | 'Ctrl' {
