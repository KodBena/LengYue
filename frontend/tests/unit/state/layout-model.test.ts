...
// HISTORICAL, deleted by dispatch L3: computeUnsetWrapperMaxWidthCss
// (CSS-Grid tracks already took over sizing this region before this
// dispatch; the function was already unconsumed by App.vue). Transcribed
// in full in .claude/dispatch-reports/lyt-space-owner-l3-build.md's
// "Transcribed disclosures" section.
...
// `computeTreePanelClampedWidthPx`, `resolveWidthConditionalPresence`,
// `clampTreeWidthForSideColumn`, `resolveTreeRowWidthPx` (both waves),
// `sumFixedRowSiblingReservationPx`, and the "generalized reservation
// end-to-end composition" integration describe block used to be pinned
// here, across roughly 750 lines. All five functions are DELETED --
// subsumed by state/feasible-layout.ts#resolveSideColumnLiveLayout
// (dispatch L3), driven live from App.vue's sideColumnLayout computed.
// Every disclosed narrowing and dated addendum those five carried (the
// 900x600 clipping regression, the axis-'h'-only demote guard, the
// 2560x1440 clip completion, the generalized-reservation addendum, the
// portrait/landscape un-dragged-widen fixes, the end-to-end 2560x1440
// composition scenario) is transcribed in full in .claude/dispatch-
// reports/lyt-space-owner-l3-build.md's "Transcribed disclosures"
