...
│   │   ├── useLytPresenceMenu.ts      [B1]  W2 (roadmap §8 W2 item 1, ledger row 1743): corner presence-menu logic — the three-target list + defaults, guarded toggle (last-remaining-panel refusal), railStyle read/write. Chrome-generic (no Go/game-tree vocabulary), matching LytNode.vue/LytPresenceMenu.vue's own [B1] tag.
